...
JSValue native_pins(JSContext *ctx, JSValue *this_val, int argc, JSValue *argv) {
    ...
    JS_SetPropertyStr(ctx, obj, "spi_sck", JS_NewInt32(ctx, bruceConfigPins.outer_bus.sck));
    JS_SetPropertyStr(ctx, obj, "spi_mosi", JS_NewInt32(ctx, bruceConfigPins.outer_bus.mosi));
    JS_SetPropertyStr(ctx, obj, "spi_miso", JS_NewInt32(ctx, bruceConfigPins.outer_bus.miso));
    JS_SetPropertyStr(ctx, obj, "spi_ss", JS_NewInt32(ctx, bruceConfigPins.outer_bus.cs));
    JS_SetPropertyStr(ctx, obj, "ir_tx", JS_NewInt32(ctx, bruceConfigPins.irTx));
    JS_SetPropertyStr(ctx, obj, "ir_rx", JS_NewInt32(ctx, bruceConfigPins.irRx));
    return obj;
}
#endif
